...
public class EmpresaController {
    ...
    public EmpresaController(Scanner sc, EmpresaService empresaService, 
                             ConsultaService consultaService, UsuarioService usuarioService) {
        this.sc = sc;
    ...
    public void consultarCnpj() {
        ...
        int tempoResposta = (int) (fim - inicio);

        if (empresa == null) {
            System.out.println("Empresa não encontrada.");
            consultaService.registrarConsulta(usuario.getIdUsuario(), null, false, "Empresa não encontrada", tempoResposta);
            return;
        }

        exibirEmpresa(empresa);
        consultaService.registrarConsulta(cnpj);
        consultaService.registrarConsulta(usuario.getIdUsuario(), empresa.getIdEmpresa(), true, null, tempoResposta);
    }
